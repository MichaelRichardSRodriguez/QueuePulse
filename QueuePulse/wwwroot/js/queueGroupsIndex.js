document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadGroups() {
        ...
        fetch(`/admin/queueGroup/getGroups?searchQuery=${searchQuery}&statusFilter=${status}`, {
            method: 'GET',
        })
    ...
    function updateGroupStatus(itemId) {
        fetch(`/admin/queueGroup/UpdateStatus/${itemId}`, {
    ...
    function renderTable(data) {
        ...
        data.forEach(item => {
            ...
            actionsCell.innerHTML = `
                <a class="btn btn-warning btn-sm w-30 ${isActive ? '' : 'disabled'}" href="/admin/queueGroup/Edit/${item.id}">Edit</a>
                <a class="btn btn-primary btn-sm w-30" href="/admin/queueGroup/Details/${item.id}">Details</a>
                <a class="btn btn-danger btn-sm w-30" href="/admin/queueGroup/Delete/${item.id}">Delete</a>
            `;
